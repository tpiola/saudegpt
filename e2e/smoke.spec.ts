...
const E2E_ADMIN_PASSWORD = "e2e-only-strong-password";
...
test.describe("Smoke — plataforma", () => {
  ...
  test("diretor entra com credenciais exclusivas e vê o painel", async ({ page }) => {
    await page.goto("/admin");
    await page.locator("#admin-user").fill(E2E_ADMIN_USER);
    await page.locator("#admin-pass").fill(E2E_ADMIN_PASSWORD);
