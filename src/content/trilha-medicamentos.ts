...
export const trilhaMedicamentos: Trilha = {
  ...
  modulos: [
      ...
      aulas: [
        {
          ...
          imagemProduto: "/imagens/produtos/generico-paracetamol.webp",
        ...
        },
        {
          ...
          imagemProduto: "/imagens/produtos/generico-ibuprofeno.webp",
        ...
        },
        {
          ...
          imagemProduto: "/imagens/produtos/eurofarma-buscopan.webp",
    ...
    },
    {
      ...
      aulas: [
        ...
        },
        {
          ...
          imagemProduto: "/imagens/produtos/neo-quimica-dorflex.webp",
    ...
    // ═══════════════════════════════════════════════════════════════
    // NOVO MÓDULO: Interações Medicamentosas — Guia de Balcão
    // Atendendo à demanda dos alunos críticos (#1 conteúdo faltante)
    // ═══════════════════════════════════════════════════════════════
    {
      id: "interacoes-medicamentosas",
      titulo: "Interações Medicamentosas — Guia de Balcão",
      descricao:
        "As 20 interações mais comuns na rotina da farmácia: como identificar, orientar e encaminhar com segurança. Atende à solicitação dos alunos que apontaram esta lacuna crítica.",
      imagemHeroUrl: imagensCategoria.medicamentos,
      aulas: [
        {
          id: "interacoes-basicas",
          titulo: "Interações básicas: AAS, anti-inflamatórios, anticoncepcionais e antibióticos",
          duracaoMin: 8,
          nivel: "intermediario",
          imagemHeroUrl: imagensCategoria.medicamentos,
          resumo:
            "As interações que mais aparecem no balcão: AAS + ibuprofeno, anticoncepcional + antibiótico, álcool + benzodiazepínicos e muito mais.",
          resumoExecutivo: [
            "AAS + anti-inflamatório (ibuprofeno, naproxeno): aumentam risco de sangramento gástrico — nunca associar sem orientação médica.",
            "Anticoncepcional + antibiótico (rifampicina, amoxicilina em altas doses): redução da eficácia contraceptiva — orientar método de barreira.",
            "Álcool + benzodiazepínicos (diazepam, clonazepam): potencialização dos efeitos sedativos — risco de depressão respiratória.",
            "Sinvastatina + suco de toranja (grapefruit): aumenta toxicidade muscular — orientar evitar a fruta.",
            "IECA (captopril, enalapril) + AINEs: redução do efeito anti-hipertensivo e risco de lesão renal.",
            "Sempre que houver dúvida sobre interação, chamar o farmacêutico.",
          ],
          checklist: [
            "Perguntar que outros medicamentos o cliente usa antes de orientar qualquer MIP.",
            "Saber que AINEs + anticoagulantes/AAS é a combinação mais perigosa no dia a dia.",
            "Anticoncepcional + antibiótico: orientar camisinha como método extra.",
            "Encaminhar ao farmacêutico qualquer combinação de tarja vermelha ou preta.",
          ],
          quandoChamarFarmaceutico: [
            "Cliente que usa anticoagulante (varfarina, rivaroxabana) + qualquer outro medicamento.",
            "Gestante ou lactante com qualquer dúvida sobre segurança de medicamentos.",
            "Cliente polimedicado (>5 medicações diárias).",
            "Qualquer suspeita de reação adversa.",
          ],
          errosComuns: [
            "Dizer 'pode tomar junto sim' sem verificar interações.",
            "Ignorar que fitoterápicos (Erva-de-São-João, Ginkgo biloba) também interagem.",
            "Achar que só remédio tarjado interage — MIPs e suplementos também.",
          ],
          produtos: [],
          marcas: [],
          simulacao: {
            cliente: "Cliente que toma AAS todo dia para o coração quer comprar ibuprofeno para dor nas costas.",
            falaBoa: "Entendo a dor, mas o AAS com ibuprofeno aumenta risco de sangramento no estomago. Vou chamar o farmaceutico para avaliar uma alternativa segura para voce.",
            falaEvitar: "Pode tomar junto, nao vai dar nada.",
          },
          quiz: [
            q(
              "Qual a interação mais perigosa entre medicamento de uso contínuo e MIP?",
              [
                "Anticoncepcional + vitamina C",
                "AAS + anti-inflamatório (ibuprofeno)",
                "Omeprazol + leite",
                "Dipirona + cafeína",
              ],
              1,
              "AAS + AINEs aumenta sangramento gastrintestinal — é a combinação de maior risco no balcão.",
            ),
            q(
              "Cliente toma anticoncepcional e vai tomar amoxicilina. Orientação correta:",
              [
                "Não precisa de cuidado extra",
                "Usar método de barreira durante o tratamento e até 7 dias após",
                "Parar o anticoncepcional",
                "Dobrar a dose do anticoncepcional",
              ],
              1,
              "Antibióticos podem reduzir eficácia de anticoncepcionais hormonais.",
            ),
            q(
              "Cliente toma sinvastatina e come toranja todo dia. Risco?",
              [
                "Nenhum, toranja é saudável",
                "Aumento da toxicidade da sinvastatina (risco muscular e hepático)",
                "Redução do colesterol bom",
                "Apenas interação com antiácidos",
              ],
              1,
              "Toranja inibe enzimas que metabolizam a sinvastatina — risco de rabdomiólise.",
            ),
            q(
              "Cliente hipertenso toma captopril e quer ibuprofeno. Risco?",
              [
                "Não há risco",
                "Redução do efeito anti-hipertensivo e risco de lesão renal",
                "Aumento da pressão apenas",
                "Interação com gordura",
              ],
              1,
              "AINEs reduzem eficácia de anti-hipertensivos e podem causar lesão renal.",
            ),
          ],
          xp: 60,
        },
        {
          id: "guia-rapido-interacoes",
          titulo: "Guia rápido de 10 interações de balcão",
          duracaoMin: 6,
          nivel: "intermediario",
          imagemHeroUrl: imagensCategoria.medicamentos,
          resumo: "Tabela prática das 10 interações mais frequentes na farmácia: o que perguntar, orientar e quando escalonar.",
          resumoExecutivo: [
            "1. AAS + Ibuprofeno: sangramento GI → chamar farmacêutico.",
            "2. Anticoncepcional + Antibiótico: reduz eficácia → método de barreira.",
            "3. Captopril/Enalapril + AINEs: reduz efeito + risco renal.",
            "4. Sinvastatina + Toranja: toxicidade muscular.",
            "5. Varfarina + AINEs: sangramento GRAVE → emergência farmacêutica.",
            "6. Álcool + Benzodiazepínicos: sedação excessiva.",
            "7. Metformina + Contraste iodado: acidose lática.",
            "8. Digoxina + Amiodarona: toxicidade digitálica.",
            "9. ISRS + IMAO: síndrome serotoninérgica.",
            "10. Cimetidina + Varfarina: aumenta efeito.",
          ],
          checklist: [
            "Sempre perguntar: 'Você toma algum outro remédio?'",
            "Ao vender antibiótico, lembre da interação com anticoncepcional.",
            "Clientes polimedicados merecem atenção extra.",
            "Fitoterápicos e suplementos também interagem!",
          ],
          quandoChamarFarmaceutico: [
            "Qualquer dúvida sobre interações das 10 listadas.",
            "Cliente com sangramento, tontura ou mal-estar após medicação.",
            "Gestantes e lactantes polimedicadas.",
          ],
          errosComuns: [
            "Achar que só remédio de tarja preta interage.",
            "Não perguntar sobre fitoterápicos (Ginkgo, Erva-de-São-João, alho).",
            "Subestimar gravidade de AINEs + anticoagulantes.",
          ],
          produtos: [],
          marcas: [],
          quiz: [
            q(
              "Qual interação é a MAIS GRAVE e exige encaminhamento imediato?",
              [
                "Omeprazol + café",
                "Varfarina + AINEs",
              ...
              1,
              "Varfarina + AINEs pode causar sangramento GI fatal. Emergência farmacêutica.",
            ),
            q(
              "Primeira pergunta ao orientar um MIP:",
              [
                "'Você tem alergia?'",
                "'Você toma algum outro medicamento?'",
                "'Qual seu plano de saúde?'",
                "'Prefere comprimido ou xarope?'",
              ],
              1,
              "Perguntar sobre outros medicamentos é essencial para identificar interações.",
            ),
            q(
              "Por que fitoterápicos também interagem?",
              [
                "Não interagem, são naturais",
                "Ginkgo, alho e Erva-de-São-João interagem com anticoagulantes, anticoncepcionais e antidepressivos",
                "Só interagem com tarja preta",
                "São inertes",
              ],
              1,
              "'Natural' não significa 'inerte' — fitoterápicos têm interações documentadas.",
            ),
          ],
          xp: 60,
        },
