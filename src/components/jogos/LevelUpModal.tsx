  ...
  return (
    <AnimatePresence>
      {!dismissed && (
        ...
        >
          <Confetti ativo={true} duracao={5000} />
          ...
          >
            {/* Top glow */}
            <div
              className="pointer-events-none absolute -inset-x-20 -top-20 h-60 rounded-full opacity-20 blur-3xl"
            ...
            <div className="relative z-10 flex flex-col items-center px-6 pb-8 pt-10 text-center">
              ...
              <motion.div
                ...
                className="flex h-24 w-24 items-center justify-center rounded-3xl border-2 border-sovereign-gold/20 bg-gradient-to-br from-sovereign-surface-3 to-sovereign-surface shadow-xl shadow-sovereign-gold/10"
              >
                <span className="text-4xl">{nivelInfo.icone}</span>
              </motion.div>
