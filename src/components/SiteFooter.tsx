              ...
              {site.patrocinadores?.map((p) => (
                <li key={p.nome}>
                  <a
                    ...
                    className="group block rounded-xl border border-white/8 bg-white/[0.03] p-3.5 transition-all hover:border-emerald-500/25 hover:bg-emerald-500/[0.05] hover:-translate-y-0.5"
                  >
