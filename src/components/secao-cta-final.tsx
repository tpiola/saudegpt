...
export function SecaoCTAFinal() {
  ...
  return (
    <section className="relative overflow-hidden bg-navy-900 py-24 sm:py-32" ref={ref}>
      <div className="absolute -top-40 -right-40 h-80 w-80 rounded-full bg-gold-500/10 blur-3xl" />
      <div className="absolute -bottom-40 -left-40 h-80 w-80 rounded-full bg-gold-500/8 blur-3xl" />
      ...
      <div className="relative mx-auto max-w-4xl px-6 text-center sm:px-8">
        ...
        >
          ...
          <div className="mt-8 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
            <Link
              href="/"
              className="inline-flex h-12 sm:h-14 items-center gap-2 rounded-2xl bg-gradient-to-r from-gold-500 to-gold-600 px-8 text-sm sm:text-base font-bold text-white shadow-xl shadow-gold-500/25 transition-all hover:shadow-gold-500/40 hover:scale-[1.02] active:scale-[0.98]"
            >
              Quero me inscrever
            </Link>
            <Link
