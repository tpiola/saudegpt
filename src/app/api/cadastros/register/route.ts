...
export async function POST(request: Request) {
  ...
  // Avisa o coordenador para aprovar o acesso (não bloqueia a resposta).
  void notificarNovoCadastro({ nome: registro.nome, email: registro.email, whatsapp: registro.whatsapp });
