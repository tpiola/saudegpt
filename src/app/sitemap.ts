...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const ESTATICAS: MetadataRoute.Sitemap = [
    ...
    { url: `${base}/privacidade`, lastModified: new Date("2026-06-01"), changeFrequency: "yearly" as const, priority: 0.3 },
    { url: `${base}/termos`, lastModified: new Date("2026-06-01"), changeFrequency: "yearly" as const, priority: 0.3 },
    ...
    { url: `${base}/nutricao`, lastModified: new Date("2026-07-04"), changeFrequency: "weekly" as const, priority: 0.85 },
    { url: `${base}/fisioterapia`, lastModified: new Date("2026-07-04"), changeFrequency: "weekly" as const, priority: 0.85 },
    { url: `${base}/psicologia`, lastModified: new Date("2026-07-04"), changeFrequency: "weekly" as const, priority: 0.85 },
