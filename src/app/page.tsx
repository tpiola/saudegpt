...
const pilares: Array<{ icon: IconName; title: string; text: string }> = [
  { icon: "shield", title: "Conteudo Verificado", text: "Baseado em ANVISA, Ministerio da Saude e OMS." },
  { icon: "zap", title: "Aulas Rapidas", text: "Trilhas de 3-8 min. Estude no intervalo." },
  { icon: "award", title: "Evolucao Visivel", text: "XP, missoes, ranking e certificado." },
];
