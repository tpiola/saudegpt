...
const topicos = [
  { titulo: "Transtornos Mentais Comuns", desc: "Identificação e compreensão dos principais transtornos na farmácia." },
  { titulo: "Medicamentos Psiquiátricos", desc: "Orientação sobre classes de psicofármacos e seus usos." },
  { titulo: "Atendimento Humanizado", desc: "Técnicas de acolhimento e comunicação empática com pacientes." },
  { titulo: "Saúde Mental e Bem-Estar", desc: "Promoção da saúde mental no dia a dia da farmácia." },
  { titulo: "Ansiedade e Depressão", desc: "Reconhecimento de sinais e orientação adequada para cada caso." },
  { titulo: "Acolhimento na Farmácia", desc: "Estratégias para criar um ambiente seguro e acolhedor." },
];

const beneficios = [
  { icone: "💚", titulo: "Atendimento Humanizado", desc: "Aprenda a acolher pacientes com empatia e respeito." },
  { icone: "🧠", titulo: "Conhecimento Especializado", desc: "Domine os fundamentos da saúde mental na farmácia." },
      ...
      <main className="overflow-hidden">
        ...
        <section className="relative px-4 pt-24 pb-16 sm:pt-32 sm:pb-20 lg:pt-40 lg:pb-28">
          ...
          <div className="relative mx-auto max-w-4xl text-center">
            ...
            >
              Curso essencial para atendentes que desejam acolher pacientes com transtornos mentais,
              orientar sobre medicamentos psiquiátricos e oferecer um atendimento humanizado e empático.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
          ...
          <div className="mx-auto max-w-4xl text-center">
            ...
            <motion.div {...fadeUp} className="grid gap-4 sm:grid-cols-2 text-left">
              {[
                ...
                "Profissionais que lidam com pacientes em sofrimento mental",
                "Farmacêuticos que buscam atendimento mais humano",
                "Estudantes de psicologia e áreas da saúde",
              ].map((item) => (
        ...
        <section className="px-4 py-16 sm:py-24">
          <div className="mx-auto max-w-3xl text-center">
            ...
            >
              Transforme seu atendimento com empatia
            </motion.h2>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              Esteja preparado para acolher, orientar e cuidar de pacientes com transtornos mentais.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
