...
const topicos = [
  { titulo: "Suplementos Alimentares", desc: "Aprenda a orientar sobre os principais suplementos disponíveis na farmácia." },
  { titulo: "Fitoterapia na Farmácia", desc: "Plantas medicinais e fitoterápicos com respaldo científico." },
  { titulo: "Interações Medicamento-Nutriente", desc: "Identifique e previna interações entre fármacos e nutrientes." },
  { titulo: "Nutrição Esportiva", desc: "Suporte nutricional para pacientes atletas e praticantes de atividade física." },
  { titulo: "Alimentação Saudável", desc: "Orientações práticas de alimentação equilibrada para o dia a dia." },
  { titulo: "Vitaminas e Minerais", desc: "Funções, deficiências e suplementação de micronutrientes." },
];

const beneficios = [
  { icone: "🧠", titulo: "Conhecimento Prático", desc: "Aplique no balcão da farmácia desde a primeira aula." },
  { icone: "📋", titulo: "Conteúdo Atualizado", desc: "Baseado nas diretrizes mais recentes da ANVISA e SBAN." },
      ...
      <main className="overflow-hidden">
        ...
        <section className="relative px-4 pt-24 pb-16 sm:pt-32 sm:pb-20 lg:pt-40 lg:pb-28">
          ...
          <div className="relative mx-auto max-w-4xl text-center">
            ...
            >
              Curso completo sobre nutrição no contexto farmacêutico. Aprenda a orientar pacientes sobre
              suplementos alimentares, interações entre medicamentos e nutrientes, alimentação saudável e Fitoterapia.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
          ...
          <div className="mx-auto max-w-4xl text-center">
            ...
            <motion.div {...fadeUp} className="grid gap-4 sm:grid-cols-2 text-left">
              {[
                ...
                "Farmacêuticos que desejam se especializar em nutrição",
                "Profissionais da saúde que atuam na dispensação",
                "Estudantes de farmácia e áreas da saúde",
              ].map((item) => (
        ...
        <section className="px-4 py-16 sm:py-24">
          <div className="mx-auto max-w-3xl text-center">
            ...
            >
              Transforme seu atendimento na farmácia
            </motion.h2>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              Domine a nutrição aplicada à farmácia e ofereça um atendimento completo e diferenciado.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
